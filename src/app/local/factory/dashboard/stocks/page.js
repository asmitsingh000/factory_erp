    ...
    <div className="p-6 text-white bg-[#080b11] min-h-screen">
      <div className="flex justify-between items-center mb-6">
        ...
        <button 
          ...
          className="bg-indigo-600 hover:bg-indigo-500 text-white text-xs px-4 py-2.5 rounded-lg font-bold transition shadow-md"
        >
          + Update Stock
        </button>
      </div>
      ...
      <div className="bg-[#0b0f19] border border-gray-800 rounded-xl overflow-hidden">
        <table className="w-full text-left text-sm border-collapse">
          <thead>
            <tr className="bg-amber-950/20 text-amber-500 border-b border-gray-800 text-xs font-semibold uppercase tracking-wider">
          ...
          <tbody>
            {loading ? (
              ...
              stocks.map((stock) => (
                <tr key={stock.id} className="border-b border-gray-800/60 hover:bg-gray-900/10 transition">
