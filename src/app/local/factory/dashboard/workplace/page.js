...
//             <h1 className="text-4xl font-bold text-white">Workplace Dashboard</h1>
...
//             <thead className="bg-[#422004] text-white-400 border-b border-gray-800">
//               <tr>
//                 <th className="p-4 font-semibold w-16 text-2xl">S.No</th>
//                 <th className="p-4 font-semibold text-2xl">Department Particulars</th>
//                 <th className="p-4 font-semibold text-2xl">Quantity Status</th>
//                 <th className="p-4 font-semibold text-2xl">System Audit Timestamp</th>
//                 {!isReadOnly && <th className="p-4 font-semibold text-center text-2xl">Actions</th>}
//               </tr>
//             </thead>
//             <tbody className="text-gray-200 divide-y divide-gray-800 text-xl">
...
//                 <td className="p-4 text-l text-gray-400">Synced - {currentMonth} {currentYear}</td>
//                 {!isReadOnly && (
//                   <td className="p-4 text-center">
//                     <button className="text-xs bg-gray-800 hover:bg-gray-700 text-gray-300 px-2 py-1 rounded border border-gray-700 font-semibold">
//                       Modify
//                     </button>
//                   </td>
//                 )}
...
// export default function WorkplacePage() {
  //   return (
    ...
    //       <WorkplaceContent />
    // redirect('/factory/dashboard/workplace/furniture');
    //     </Suspense>
    //   );
    // }
    import { redirect } from 'next/navigation';
    
    export default function WorkplaceRotePageladleeeeee() {
      redirect('/factory/dashboard/workplace/furniture');
    }